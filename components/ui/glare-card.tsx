...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-full md:w-[250px] lg:w-[300px] [aspect-ratio:10/3] md:[aspect-ratio:17/21] lg:[aspect-ratio:17/21]"
      ref={refElement}
      onPointerMove={(event) => {
